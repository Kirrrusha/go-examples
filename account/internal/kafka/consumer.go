...
func NewConsumer(cfg ConsumerConfig, logger *zerolog.Logger) (*Consumer, error) {
	...
	reader := kafkago.NewReader(kafkago.ReaderConfig{
		Brokers: cfg.Brokers, GroupID: cfg.GroupID, Topic: cfg.Topics[0],
		MinBytes: cfg.MinBytes, MaxBytes: cfg.MaxBytes, MaxWait: cfg.MaxWait,
		ReadBatchTimeout: cfg.ReadBatchTimeout, HeartbeatInterval: cfg.HeartbeatInterval,
